...
export const Header = () => {
  ...
  // Effect to control body background
  useEffect(() => {
    if (isMenuOpen) {
      document.body.style.background = 'linear-gradient(to bottom right, rgb(220, 38, 38), rgb(153, 27, 27))';
    } else {
    ...
    <>
      <motion.header
        ...
        className={`fixed w-full top-0 z-[999] transition-all duration-300 ${
          scrolled || !isHomePage
            ? "bg-white/95 text-gray-800 shadow-lg backdrop-blur-lg py-2"
      ...
      >
        <div className='container mx-auto px-4'>
          <div className='flex justify-between items-center'>
            ...
            {/* Mobile Menu Button */}
            <motion.button
              className='lg:hidden rounded-full p-2 z-[60]'
